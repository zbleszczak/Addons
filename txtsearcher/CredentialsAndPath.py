...
# get the current directory as the base path for the search
path = os.getcwd()

# ask the user for the keyword to search for
keyword = input("Enter the keyword to search for: ")

# ask the user for the URL to search for
        ...
        if file.endswith(".txt") and file.lower() == "passwords.txt":
            ...
            with open(file_path, "r", encoding="utf-8", errors="replace") as f:
                try:
                    ...
                    if keyword in contents and url in contents:
                        # increment the counter and print the username, password, url and path
                        count += 1
...
# pause the program so that the user can see the output
